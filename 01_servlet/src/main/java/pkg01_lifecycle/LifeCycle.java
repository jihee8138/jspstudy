...
public class LifeCycle extends HttpServlet {
   ...
   * 
   * service()
   * 1. 클라이언트로부터 요청을 받을 수 있다. (매개변수 HttpServeletRequest request)
   * 2. 클라이언트에게 응답할 수 있다.        (매개변수 HttpServeletResponse reponse)
   * 3. service() 메소드가 있으면 여기서 요청과 응답을 해결한다.
   * 4. servixe() 메소드가 없으면 doGet() 또는 doPost() 메소드가 요청에 따라 호출된다.
   */
